...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="title" id="buku" placeholder="Roasting sesuka hati" class="form-control">
      </div>
      <div class="mb-3">
        <label for="deskripsi" class="form-label">DESKRIPSI</label>
        <textarea class="form-control" name="description" id="deskripsi" placeholder="isi buku tersebut" rows="3"></textarea>
      </div>
